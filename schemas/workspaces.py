...
class WorkspaceUpdate(BaseModel):
    """API PUT body model."""
    name: str | None = Field(default=None, description="Name of the workspace", min_length=1)


class WorkspaceOut(WorkspaceDocumentModel):
    """API Response model."""
    id: AnnotatedObjectId = Field(..., alias="_id", description="Workspace ID")
    created_by: AnnotatedObjectId = Field(..., description="Id of the user who created the workspace")
